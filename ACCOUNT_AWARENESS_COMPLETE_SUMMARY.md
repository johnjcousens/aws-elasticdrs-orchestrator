...
- `aws-drs-orchestration-data-management-handler-test`
- `aws-drs-orchestration-execution-handler-test`
- `aws-drs-orchestration-query-handler-test`
...
```json
{
  "groupId": "pg-123",
  "groupName": "My Group",
  "accountId": "111122223333",  // ✅ Stored directly
  "region": "us-west-2",
...
1. **Select Account**: Choose "DEMO_TARGET (111122223333)" from dropdown
...
5. **Create Protection Group**: 
   ...
   - Should only see servers from account 111122223333
   - Should NOT see servers from account 777788889999

### Browser DevTools Verification

1. Open DevTools (F12) → Network tab
2. Select an account
3. Verify API requests include `?accountId=111122223333`
