...
- Launch configuration settings per Protection Group
...
- **Invocation Source Tracking**: Tracks execution source (UI, CLI, API, EventBridge, SSM, Step Functions)
...
- Tag-based server selection with preview capability
- Invocation source tracking display
