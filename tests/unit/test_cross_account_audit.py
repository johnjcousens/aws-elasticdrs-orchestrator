...
def lambda_context():
    ...
    context = MagicMock()
    context.invoked_function_arn = "arn:aws:sts::123456789012:assumed-role/QueryHandlerRole/session-123"
...
class TestCrossAccountDRSQueryAuditLogging:
    ...
    def test_cross_account_query_audit_log_fields(
        ...
        principal_info = {
            ...
            "principal_arn": "arn:aws:iam::123456789012:role/QueryHandlerRole",
        ...
        assert item["source_account"] == "123456789012"
...
class TestSourceAndTargetAccountFields:
    ...
    def test_same_account_query_has_matching_source_and_target(
        ...
        same_account_event = {
            "operation": "list_source_servers",
            "targetAccountId": "123456789012",  # Same as hub account
            "region": "us-east-2"
        }
...
class TestAuditLogAggregationQueries:
    ...
    def test_query_audit_logs_by_user(
        ...
        response = mock_dynamodb.query(
            ...
            ExpressionAttributeValues={":principal": "arn:aws:iam::123456789012:role/QueryHandlerRole"}
        )
...
class TestCentralizedAuditTrail:
    ...
    def test_audit_log_retention_and_encryption(
        ...
        audit_log = {
            ...
            "encryption_key_id": "arn:aws:kms:us-east-2:123456789012:key/12345678-1234-1234-1234-123456789012"
        }
