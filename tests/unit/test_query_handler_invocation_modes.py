...
def mock_lambda_context():
    ...
    context.invoked_function_arn = (
        "arn:aws:lambda:us-east-1:210987654321:function:aws-drs-orchestration-query-handler-qa"
    )
...
class TestAPIGatewayInvocation:
    ...
    def test_api_gateway_invocation_with_cognito_user(self, mock_lambda_context):
        ...
        with patch("index.get_current_account_id", return_value="210987654321"):
...
class TestDirectLambdaInvocation:
    ...
    def test_step_functions_invocation_assumed_role(self, mock_lambda_context):
        ...
        mock_lambda_context.invoked_function_arn = (
            "arn:aws:sts::210987654321:assumed-role/StepFunctionsExecutionRole/execution-abc123"
        )
        ...
        assert principal_info["principal_arn"] == "arn:aws:iam::210987654321:role/StepFunctionsExecutionRole"
        assert principal_info["session_name"] == "execution-abc123"
        assert principal_info["account_id"] == "210987654321"
    ...
    def test_eventbridge_invocation_service_principal(self, mock_lambda_context):
        ...
        service_arn = "arn:aws:events::210987654321:rule/inventory-sync-rule"
    ...
    def test_iam_role_invocation(self, mock_lambda_context):
        ...
        # Mock IAM role ARN
        role_arn = "arn:aws:iam::210987654321:role/OrchestrationRole"
    ...
    def test_iam_user_invocation(self, mock_lambda_context):
        ...
        # Mock IAM user ARN
        user_arn = "arn:aws:iam::210987654321:user/admin-user"
...
class TestInvocationModeDetection:
    ...
    def test_detects_direct_lambda_mode_with_operation(self, mock_lambda_context):
        ...
        mock_lambda_context.invoked_function_arn = (
            "arn:aws:iam::210987654321:role/TestRole"
        )

        # Mock extract_iam_principal at the shared module level
        with patch("shared.iam_utils.extract_iam_principal", return_value="arn:aws:iam::210987654321:role/TestRole"):
            with patch("index.handle_direct_invocation", return_value={"accountId": "210987654321"}):
                result = lambda_handler(event, mock_lambda_context)
    ...
    def test_detects_direct_lambda_mode_with_action(self, mock_lambda_context):
        ...
        mock_lambda_context.invoked_function_arn = (
            "arn:aws:sts::210987654321:assumed-role/StepFunctionsRole/exec-123"
        )

        # Mock extract_iam_principal at the shared module level
        with patch("shared.iam_utils.extract_iam_principal", return_value="arn:aws:sts::210987654321:assumed-role/StepFunctionsRole/exec-123"):
...
class TestStepFunctionsInvocation:
    ...
    def test_step_functions_invocation_with_assumed_role(self, mock_lambda_context):
        ...
        # Mock Step Functions assumed role ARN
        arn = "arn:aws:sts::210987654321:assumed-role/aws-drs-orchestration-StepFunctionsRole-qa/execution-abc123"
        ...
        assert principal_info["invocation_mode"] == "DIRECT_LAMBDA"
        assert principal_info["principal_type"] == "AssumedRole"
        assert principal_info["principal_arn"] == "arn:aws:iam::210987654321:role/aws-drs-orchestration-StepFunctionsRole-qa"
        assert principal_info["session_name"] == "execution-abc123"
        assert principal_info["account_id"] == "210987654321"
    ...
    def test_step_functions_invocation_with_wave_polling(self, mock_lambda_context):
        ...
        arn = "arn:aws:sts::210987654321:assumed-role/aws-drs-orchestration-StepFunctionsRole-qa/wave-poll-exec-123"
    ...
    def test_step_functions_invocation_audit_log_fields(self, mock_lambda_context):
        ...
        # Mock Step Functions assumed role ARN
        arn = "arn:aws:sts::210987654321:assumed-role/ExecutionRole/session-xyz"
        ...
        assert principal_info["invocation_mode"] == "DIRECT_LAMBDA"
        assert principal_info["principal_type"] == "AssumedRole"
        assert principal_info["principal_arn"] == "arn:aws:iam::210987654321:role/ExecutionRole"
...
class TestEventBridgeInvocation:
    ...
    def test_eventbridge_invocation_with_service_principal(self, mock_lambda_context):
        ...
        # Mock EventBridge service principal ARN
        arn = "arn:aws:events::210987654321:rule/aws-drs-orchestration-inventory-sync-rule"
    ...
    def test_eventbridge_invocation_with_inventory_sync(self, mock_lambda_context):
        ...
        arn = "arn:aws:events::210987654321:rule/inventory-sync-rule"
    ...
    def test_eventbridge_invocation_audit_log_fields(self, mock_lambda_context):
        ...
        # Mock EventBridge service principal ARN
        arn = "arn:aws:events::210987654321:rule/staging-sync-rule"
...
class TestInvocationModeAuditLogging:
    ...
    def test_direct_lambda_invocation_mode_field(self, mock_lambda_context):
        ...
        arn = "arn:aws:iam::210987654321:role/TestRole"
    ...
    def test_iam_arn_principal_extraction(self, mock_lambda_context):
        ...
        arn = "arn:aws:sts::210987654321:assumed-role/ExecutionRole/session-123"
