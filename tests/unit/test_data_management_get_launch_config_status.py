...
class TestGetLaunchConfigStatus:
    ...
    def test_get_status_ready(self):
        ...
        with patch("shared.launch_config_service.get_config_status") as mock_get_config:
            with patch.object(data_management_handler, "get_protection_groups_table") as mock_get_table:
    ...
    def test_get_status_group_not_found(self):
    ...
    def test_get_status_frontend_invocation(self):
    ...
    def test_get_status_api_invocation(self):
    ...
    def test_get_status_direct_invocation(self):
        """Test get status via Direct Lambda invocation."""
        with patch("shared.iam_utils.extract_iam_principal") as mock_extract_principal:
            with patch("shared.iam_utils.validate_iam_authorization") as mock_validate_auth:
                with patch("shared.launch_config_service.get_config_status") as mock_get_config:
                    with patch.object(data_management_handler, "get_protection_groups_table") as mock_get_table:
                        # Mock IAM validation
