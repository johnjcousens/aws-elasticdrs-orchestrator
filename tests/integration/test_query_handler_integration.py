...
def test_iam_authorization_success(mock_validate, mock_extract_principal, mock_env_vars):
    """
...
def test_response_format_direct_invocation(mock_table, mock_extract_principal, mock_env_vars):
    ...
    assert "accounts" in result or "targetAccounts" in result or "error" in result
...
@patch("shared.iam_utils.extract_iam_principal")
@patch("index.target_accounts_table")
def test_query_operations_routing(mock_table, mock_extract_principal, operation, mock_env_vars):
    """
...
@patch("index.target_accounts_table")
def test_audit_logging_called(mock_table, mock_log, mock_extract_principal, mock_env_vars):
    """
