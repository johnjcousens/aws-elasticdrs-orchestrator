...
def get_mock_context(principal_arn=None):
    ...
    if principal_arn is None:
        principal_arn = "arn:aws:lambda:us-east-1:111111111111:function:query-handler"
...
def test_extract_iam_principal_from_function_arn():
    ...
    """
    context = get_mock_context("arn:aws:lambda:us-east-1:111111111111:function:query-handler")
...
def test_extract_iam_principal_from_assumed_role():
    ...
    context.identity.user_arn = "arn:aws:sts::111111111111:assumed-role/OrchestrationRole/session-123"
...
def test_validate_orchestration_role_assumed_authorized():
    ...
    """
    principal_arn = "arn:aws:sts::111111111111:assumed-role/OrchestrationRole/session-123"
...
def test_validate_step_functions_role_authorized():
    ...
    - Authorization succeeds
    """
    principal_arn = "arn:aws:iam::111111111111:role/StepFunctionsExecutionRole"
...
def test_validate_lambda_execution_role_authorized():
    ...
    """
    principal_arn = "arn:aws:iam::111111111111:role/LambdaExecutionRole"
...
def test_validate_admin_assumed_role_authorized():
    ...
    - Authorization succeeds
    """
    principal_arn = "arn:aws:sts::111111111111:assumed-role/AdminRole/session-456"
...
def test_validate_service_role_authorized():
    ...
    """
    principal_arn = (
        "arn:aws:iam::111111111111:role/aws-service-role/" "states.amazonaws.com/AWSServiceRoleForStepFunctions"
    )
...
def test_log_direct_invocation_with_step_functions_role(caplog):
    ...
    principal = "arn:aws:sts::111111111111:assumed-role/" "StepFunctionsExecutionRole/execution-123"
...
def test_log_direct_invocation_truncates_large_results(caplog):
    ...
    # Create large result
    large_result = {"protectionGroups": [{"groupId": f"pg-{i}", "name": f"Group {i}"} for i in range(100)]}
