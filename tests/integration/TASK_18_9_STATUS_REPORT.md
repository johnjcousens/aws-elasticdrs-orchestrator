...
1. **AWS Credentials**: Valid credentials for QA account (210987654321)
2. **IAM Permissions**:
...
**Date**: 2025-02-26  
**Environment**: QA stack (aws-drs-orchestration-qa, us-east-2, account 210987654321)  
**AWS Profile**: 210987654321_AdministratorAccess (SSO credentials)
...
User: arn:aws:sts::210987654321:assumed-role/AWSReservedSSO_AdministratorAccess_e014ff75e5aa7705/jocousen@amazon.com 
is not authorized to perform: sts:AssumeRole on resource: 
arn:aws:iam::123456789013:role/DRSOrchestrationRole
```

**Analysis**:
- The QA account (210987654321) cannot assume the role in target account 123456789013
...
```bash
source .venv/bin/activate
AWS_PROFILE=210987654321_AdministratorAccess AWS_PAGER="" python -m pytest tests/integration/test_external_id_property.py -v -s
```
...
1. Configure AWS credentials for QA account (210987654321)
