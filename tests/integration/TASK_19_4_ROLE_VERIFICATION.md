...
|----------------|---------------|-----------------|--------|
| QueryHandlerFunction | QueryHandlerRole | `arn:aws:iam::210987654321:role/aws-drs-orchestration-query-handler-role-qa` | ✅ CORRECT |
| DataManagementHandlerFunction | DataManagementRole | `arn:aws:iam::210987654321:role/aws-drs-orchestration-data-management-role-qa` | ✅ CORRECT |
| ExecutionHandlerFunction | ExecutionHandlerRole | `arn:aws:iam::210987654321:role/aws-drs-orchestration-execution-handler-role-qa` | ✅ CORRECT |
| DrOrchestrationStepFunctionFunction | OrchestrationRole | `arn:aws:iam::210987654321:role/aws-drs-orchestration-orchestration-role-qa` | ✅ CORRECT |
| FrontendDeployerFunction | FrontendDeployerRole | `arn:aws:iam::210987654321:role/aws-drs-orchestration-frontend-deployer-role-qa` | ✅ CORRECT |
