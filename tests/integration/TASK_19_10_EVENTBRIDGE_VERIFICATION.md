...
```json
{
    ...
    "Arn": "arn:aws:events:us-east-2:210987654321:rule/aws-drs-orchestration-execution-polling-schedule-qa",
...
```json
{
    ...
    "Arn": "arn:aws:lambda:us-east-2:210987654321:function:aws-drs-orchestration-execution-handler-qa",
...
```json
{
    ...
    "Role": "arn:aws:iam::210987654321:role/aws-drs-orchestration-execution-handler-role-qa"
}
```
