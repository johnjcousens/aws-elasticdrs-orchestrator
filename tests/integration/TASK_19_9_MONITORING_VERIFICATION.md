...
```json
{
    ...
    "Statistic": "Sum",
    "AlarmActions": [
        "arn:aws:sns:us-east-2:210987654321:aws-drs-orchestration-drs-alerts-qa"
    ]
}
```
...
**SNS Topic**: arn:aws:sns:us-east-2:210987654321:aws-drs-orchestration-drs-alerts-qa
