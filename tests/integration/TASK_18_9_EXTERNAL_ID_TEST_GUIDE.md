...
You must have valid AWS credentials configured for the QA account (210987654321):
  ...
  "Statement": [
    {
      ...
      "Resource": "arn:aws:dynamodb:us-east-2:210987654321:table/aws-drs-orchestration-target-accounts-qa"
    },
    {
      "Effect": "Allow",
...
✓ AssumeRole correctly failed with AccessDenied
  Error: AccessDenied
  Message: User: arn:aws:sts::210987654321:assumed-role/... is not authorized to perform: sts:AssumeRole on resource: arn:aws:iam::160885257264:role/DRSOrchestrationRole
```
...
2. Trust policy allows the QA account (210987654321) to assume the role
