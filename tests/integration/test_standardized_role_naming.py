...
# Test configuration
ORCHESTRATION_ACCOUNT_ID = "438465159935"
...
class TestStandardizedRoleNaming:
    ...
    def test_03_role_arn_construction_pattern(
        self, aws_clients, current_account_id
    ):
        """
        ...
        expected_arn = (
            f"arn:aws:iam::{current_account_id}:role/{STANDARD_ROLE_NAME}"
        )
    ...
    def test_05_add_target_account_without_role_arn(
        self, current_account_id, external_id
    ):
        """
    ...
    def test_06_verify_role_arn_stored_in_dynamodb(
        self, aws_clients, current_account_id
    ):
        """
        ...
        table_name = os.getenv(
            ...
            "aws-drs-orchestration-target-accounts-test"
        )
        
        try:
            response = aws_clients["dynamodb"].get_item(
                TableName=table_name,
                Key={"accountId": {"S": current_account_id}}
            )
            ...
            if "Item" in response:
                ...
                expected_arn = (
                    f"arn:aws:iam::{current_account_id}:role/"
                    f"{STANDARD_ROLE_NAME}"
                )
    ...
    def test_07_cross_account_role_assumption(
        self, aws_clients, current_account_id, external_id
    ):
        """
        ...
        try:
            ...
            if e.response["Error"]["Code"] == "AccessDenied":
                pytest.skip(
                    "Cannot assume role from this account. "
                    "Test from orchestration account."
                )
            raise
    ...
    def test_09_validation_accepts_both_formats(self):
        ...
        test_cases = [
            ...
            {
                "name": "Custom ARN",
                "arn": "arn:aws:iam::123456789012:role/CustomRole-dev",
                "should_accept": True
            },
            {
    ...
    def test_construct_role_arn(self):
        ...
        spec = importlib.util.spec_from_file_location(
            ...
            os.path.join(
                ...
                'lambda', 'shared', 'account_utils.py'
            )
        )
