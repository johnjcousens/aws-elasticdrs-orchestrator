...
# Configuration
REGION="us-east-1"
STATE_MACHINE_ARN="arn:aws:states:us-east-1:210987654321:stateMachine:aws-drs-orchestration-orchestration-qa"
                ...
                {\"M\": {
                    ...
                    \"servers\": {\"L\": [
                        {\"M\": {
                            ...
                            \"targetAccountId\": {\"S\": \"210987654321\"}
                        }}
                    ]}
                }}
            ]},
...
start_step_functions_execution() {
    ...
    INPUT="{
        ...
        \"accountContext\": {
            \"hubAccountId\": \"210987654321\",
            \"targetAccounts\": [\"210987654321\"]
        }
    }"
...
main() {
    ...
    local SF_EXECUTION_ARN="arn:aws:states:us-east-1:210987654321:execution:aws-drs-orchestration-orchestration-qa:test-wave-polling-${TIMESTAMP}"
