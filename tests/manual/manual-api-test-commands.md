...
curl -X POST \
  ...
  "https://***REMOVED***.execute-api.us-east-1.amazonaws.com/test/protection-groups"
```
...
curl -X POST \
  ...
  "https://***REMOVED***.execute-api.us-east-1.amazonaws.com/test/recovery-plans"
```
...
curl -H "Authorization: Bearer $TOKEN" \
  "https://***REMOVED***.execute-api.us-east-1.amazonaws.com/test/recovery-plans/PLAN_ID"
```
...
curl -X POST \
  ...
  "https://***REMOVED***.execute-api.us-east-1.amazonaws.com/test/executions"

# Monitor execution
curl -H "Authorization: Bearer $TOKEN" \
  "https://***REMOVED***.execute-api.us-east-1.amazonaws.com/test/executions/EXECUTION_ID"

# Resume paused wave
curl -X POST \
  -H "Authorization: Bearer $TOKEN" \
  "https://***REMOVED***.execute-api.us-east-1.amazonaws.com/test/executions/EXECUTION_ID/resume"
```
