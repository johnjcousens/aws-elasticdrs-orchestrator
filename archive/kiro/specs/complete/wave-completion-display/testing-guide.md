...
### Required Access
- AWS Console access to account 123456789012
...
aws s3 ls s3://aws-drs-orchestration-fe-123456789012-dev/ --recursive | grep index.html
```
