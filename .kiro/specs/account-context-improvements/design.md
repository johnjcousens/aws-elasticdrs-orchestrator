...
**Table Name**: `aws-drs-orchestration-protection-groups-{environment}`
...
**Table Name**: `aws-drs-orchestration-recovery-plans-{environment}`
...
**Table Name**: `aws-drs-orchestration-executions-{environment}`
...
python scripts/backfill-protection-groups.py --table aws-drs-orchestration-protection-groups-dev

# Apply changes
python scripts/backfill-protection-groups.py --table aws-drs-orchestration-protection-groups-dev --apply
```
...
python scripts/backfill-recovery-plans.py \
  --plans-table aws-drs-orchestration-recovery-plans-dev \
  --groups-table aws-drs-orchestration-protection-groups-dev
...
python scripts/backfill-protection-groups.py \
  --table aws-drs-orchestration-protection-groups-dev
