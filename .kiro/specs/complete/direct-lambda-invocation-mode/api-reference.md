...
response = lambda_client.invoke(
    FunctionName='aws-drs-orchestration-execution-handler-dev',
    InvocationType='RequestResponse',
    Payload=json.dumps({
        'operation': 'start_execution',
        'planId': 'plan-xyz789',
  ...
  "Statement": [
    {
      ...
      "Resource": [
        ...
        "arn:aws:lambda:us-east-1:123456789012:function:aws-drs-orchestration-data-management-handler-dev"
      ]
    }
  ]
}
  ...
  "Statement": [
    {
      "Effect": "Allow",
      "Action": "lambda:InvokeFunction",
      "Resource": "arn:aws:lambda:us-east-1:123456789012:function:aws-drs-orchestration-query-handler-dev"
    }
  ]
}
```
...
aws iam simulate-principal-policy \
  ...
  --resource-arns arn:aws:lambda:us-east-1:123456789012:function:aws-drs-orchestration-query-handler-dev
```
