...
- `aws-drs-orchestration-dev` (master stack)
- `aws-drs-orchestration-dev-*` (all nested stacks)
- `aws-drs-orchestration-github-oidc-dev` (OIDC authentication stack)
...
- Stack ARN: `arn:aws:cloudformation:us-east-2:123456789012:stack/aws-drs-orch-dev/0f8d1db0-f3d7-11f0-af5c-0eb8e4e8f475`
