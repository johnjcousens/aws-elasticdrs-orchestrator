# External DRS Deployment Strategy

## Overview

The External environment uses a **split deployment strategy** for DRS agent installation:

- **01/02 instances**: Same-account replication (160885257264 → 160885257264)
- **03/04 instances**: Cross-account replication (160885257264 → 123456789012)
...
└── 03/04 Instances (Test/Dev)
    ...
    └─→ DRS Replication → Staging Account (123456789012)
```
...
| Instance Name | Instance ID | Type | Target Account |
|--------------|-------------|------|----------------|
| hrp-core-web03 | i-00c5c7b3cf6d8abeb | Web | 123456789012 |
| hrp-core-web04 | i-04d81abd203126050 | Web | 123456789012 |
| hrp-core-app03 | i-0b5fcf61e94e9f599 | App | 123456789012 |
| hrp-core-app04 | i-0b40c1c713cfdeac8 | App | 123456789012 |
| hrp-core-db03 | i-0d780c0fa44ba72e9 | DB | 123456789012 |
| hrp-core-db04 | i-0117a71b9b09d45f7 | DB | 123456789012 |
...
4. Verify agent was installed with `--account-id 123456789012`
