...
if [ -z "$TIER" ]; then
    echo -e "${CYAN}=== External DRS Agent Deployment (SSM Document) ===${NC}"
    echo ""
    echo "Usage: $0 <tier>"
    echo ""
    echo "Options:"
...
case "$TIER" in
    web-01-02)
        ...
        ;;
    web-03-04)
        deploy "$WEB_03_04" "123456789012" "Web 03/04 (Cross-Account)"
        ;;
    app-01-02)
        deploy "$APP_01_02" "" "App 01/02 (Same-Account)"
        ;;
    app-03-04)
        deploy "$APP_03_04" "123456789012" "App 03/04 (Cross-Account)"
        ;;
    db-01-02)
        deploy "$DB_01_02" "" "DB 01/02 (Same-Account)"
        ;;
    db-03-04)
        deploy "$DB_03_04" "123456789012" "DB 03/04 (Cross-Account)"
        ;;
    all-01-02)
        deploy "$WEB_01_02" "" "Web 01/02 (Same-Account)"
        deploy "$APP_01_02" "" "App 01/02 (Same-Account)"
    ...
    all)
        ...
        deploy "$WEB_03_04" "123456789012" "Web 03/04"
        deploy "$APP_03_04" "123456789012" "App 03/04"
        deploy "$DB_03_04" "123456789012" "DB 03/04"
        ;;
    *)
