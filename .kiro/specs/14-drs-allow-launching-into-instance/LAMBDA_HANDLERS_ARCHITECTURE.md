...
DATA_MGMT_FUNCTION = 'aws-drs-orchestration-data-management-handler-dev'
EXECUTION_FUNCTION = 'aws-drs-orchestration-execution-handler-dev'
...
```bash
# DynamoDB Tables
PROTECTION_GROUPS_TABLE=aws-drs-orchestration-protection-groups-dev
RECOVERY_PLANS_TABLE=aws-drs-orchestration-recovery-plans-dev
EXECUTION_HISTORY_TABLE=aws-drs-orchestration-execution-history-dev
TARGET_ACCOUNTS_TABLE=aws-drs-orchestration-target-accounts-dev
TAG_SYNC_CONFIG_TABLE=aws-drs-orchestration-tag-sync-config-dev
