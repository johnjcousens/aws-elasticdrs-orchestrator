...
context.invoked_function_arn = "arn:aws:sts::123456789012:assumed-role/ExecutionRole/session-name"

# Extracted principal
{
    "principal_type": "AssumedRole",
    "principal_arn": "arn:aws:iam::123456789012:role/ExecutionRole",
...
context.invoked_function_arn = "arn:aws:iam::123456789012:user/admin-user"

# Extracted principal
{
    "principal_type": "User",
    "principal_arn": "arn:aws:iam::123456789012:user/admin-user",
    "session_name": None,
    "account_id": "123456789012"
}
```
...
context.invoked_function_arn = "arn:aws:events::123456789012:rule/inventory-sync"

# Extracted principal
{
    "principal_type": "Service",
    "principal_arn": "arn:aws:events::123456789012:rule/inventory-sync",
    "session_name": None,
    "account_id": "123456789012"
}
```
...
```python
{
    ...
    "source_account": "123456789012",          # Hub account
...
```python
{
    ...
    # Hub Account Context
    "account_id": "123456789012",              # Hub account
    "source_account": "123456789012",          # Where Lambda runs
