...
Cross-account DRS agent installations (03/04 instances) are failing because the staging account (123456789012) is missing the required trusted account configuration.
...
Add source account (160885257264) as a "Trusted Account" in the staging account (123456789012).
...
```json
{
    "Role": {
        ...
        "Arn": "arn:aws:iam::123456789012:role/service-role/DRSFailbackRole_160885257264",
...
Assume Role: DRSFailbackRole_160885257264 in staging account
    ↓
DRS Agent registers in Staging Account (123456789012)
    ↓
Replication begins
```
...
- [ ] Staging account (123456789012) has DRS initialized
...
**Cross-Account (03/04)**:
- ✓ web-03-04: Replicating in account 123456789012
- ✓ app-03-04: Replicating in account 123456789012
- ✓ db-03-04: Replicating in account 123456789012
