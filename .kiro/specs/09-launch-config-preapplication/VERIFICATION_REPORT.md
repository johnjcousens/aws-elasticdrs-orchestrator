...
**Date**: 2026-02-17  
**Environment**: dev (123456789012, us-east-2)  
...
3. **Execute Wave Recovery**
   ...
   aws stepfunctions start-execution \
     --state-machine-arn arn:aws:states:us-east-2:123456789012:stateMachine:aws-drs-orchestration-orchestration-dev \
...
5. **Check CloudWatch Logs**
   ...
   aws logs tail /aws/lambda/aws-drs-orchestration-execution-handler-dev \
