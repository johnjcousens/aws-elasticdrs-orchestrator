...
- [x] 1. Create shared active region filter module
...
- [x] 1.1 Write property test for active region filtering consistency
  - **Property 1: Active Region Filtering Consistency**
  - **Validates: Requirements 1.2, 2.2, 3.2, 4.2, 9.2**

- [x] 1.2 Write property test for fallback to all regions
  - **Property 2: Fallback to All Regions**
  - **Validates: Requirements 1.3, 1.4, 2.3, 3.3, 6.1, 6.2, 6.4, 8.1**

- [x] 1.3 Write property test for cache TTL behavior
  - **Property 8: Cache TTL Behavior**
  - **Validates: Requirements 10.4**

- [x] 1.4 Write property test for pagination handling
  - **Property 7: Pagination Handling**
  - **Validates: Requirements 10.3**

- [x] 2. Create shared inventory query module
...
- [x] 2.1 Write property test for inventory database freshness check
  - **Property 4: Inventory Database Freshness Check**
  - **Validates: Requirements 12.3, 12.4, 12.8**

- [x] 2.2 Write property test for inventory data completeness
...
- [x] 4. Update tag sync to use active region filtering
...
- [x] 4.1 Write property test for tag sync region filtering
  - **Property 1: Active Region Filtering Consistency** (tag sync specific)
  - **Validates: Requirements 2.2**

- [x] 5. Update inventory sync to use active region filtering and update region status
...
- [x] 5.1 Write property test for region status table updates
  - **Property 3: Region Status Table Updates**
  - **Validates: Requirements 5.1, 5.3, 5.4, 5.5**

- [x] 5.2 Write property test for cache invalidation
  - **Property 6: Cache Invalidation**
  - **Validates: Requirements 10.5**

- [x] 6. Checkpoint - Verify tag sync and inventory sync optimizations
...
- [x] 7. Copy staging account sync functions to data-management-handler
...
- [x] 8. Update copied staging account sync functions to use region filtering
...
- [x] 8.1 Write property test for staging sync region filtering
  - **Property 11: Moved Functions Use Region Filtering**
  - **Validates: Requirements 11.12**

- [x] 8.2 Write property test for API call reduction
  - **Property 5: API Call Reduction**
  - **Validates: Requirements 9.4, 12.5**

- [x] 8.3 Write property test for cross-account IAM assumptions
  - **Property 12: Cross-Account IAM Assumptions Limited to Active Regions**
  - **Validates: Requirements 9.3**

- [x] 9. Update data-management-handler direct invocation routing
...
- [x] 9.1 Write unit test for direct invocation routing
  - Test that `sync_staging_accounts` operation calls correct function
  - **Validates: Requirements 11.10**

- [x] 10. Update CloudFormation EventBridge stack
