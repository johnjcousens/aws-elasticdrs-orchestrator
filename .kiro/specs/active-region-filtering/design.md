...
Existing table: `aws-drs-orchestration-drs-region-status-dev`
...
Existing table: `aws-drs-orchestration-source-server-inventory-dev`
...
aws cloudformation deploy --stack-name aws-drs-orchestration-dev
aws lambda update-function-code --function-name aws-drs-orchestration-data-management-handler-dev
```
...
aws logs tail /aws/lambda/aws-drs-orchestration-data-management-handler-dev --since 5m --follow
```
...
aws events list-targets-by-rule --rule aws-drs-orchestration-staging-account-sync-dev
...
```bash
# Monitor Lambda logs
aws logs tail /aws/lambda/aws-drs-orchestration-data-management-handler-dev --follow
...
aws events list-targets-by-rule \
  --rule aws-drs-orchestration-staging-account-sync-dev

# Check DynamoDB region status table
aws dynamodb scan \
  --table-name aws-drs-orchestration-drs-region-status-dev \
  --max-items 10
```
