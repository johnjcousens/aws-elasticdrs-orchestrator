...
Install DRS agents on instances in account **160885257264** that replicate to account **123456789012**:
...
### 1. Staging Account (123456789012)
```bash
# Initialize DRS
...
You should see source servers from account 160885257264 registered in account 123456789012.

## External Instance IDs
