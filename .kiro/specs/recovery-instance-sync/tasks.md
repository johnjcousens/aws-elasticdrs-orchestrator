...
# Verify stack status
aws cloudformation describe-stacks --stack-name aws-drs-orchestration-dev

# Check Lambda logs
aws logs tail /aws/lambda/aws-drs-orchestration-data-management-handler-dev
```
...
aws dynamodb scan --table-name aws-drs-orchestration-recovery-instances-dev
```
