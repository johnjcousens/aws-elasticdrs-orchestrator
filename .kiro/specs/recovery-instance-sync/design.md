...
**Table Name**: `aws-drs-orchestration-recovery-instances-{environment}`
...
```python
{
    ...
    "sourceInstanceProfile": "arn:aws:iam::123456789012:instance-profile/MyAppRole"
}
```
...
def sync_recovery_instances_after_wave(execution_id, wave_number, source_server_ids):
    ...
    table = dynamodb.Table('aws-drs-orchestration-recovery-instances-{env}')
...
**Function Name**: `aws-drs-orchestration-recovery-instance-sync-{environment}`
...
**Log Groups**:
- `/aws/lambda/aws-drs-orchestration-recovery-instance-sync-dev`
