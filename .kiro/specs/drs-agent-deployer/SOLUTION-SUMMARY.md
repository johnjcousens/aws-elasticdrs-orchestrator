...
DRS Agent Installation
    ↓
├─ 01/02: Same-account replication (160885257264 → 160885257264)
└─ 03/04: Cross-account replication (160885257264 → 123456789012)
```
...
- [External Deployment Strategy](docs/EXTERNAL_DRS_DEPLOYMENT_STRATEGY.md)
