# External DRS Agent Deployment - Quick Reference

## Deployment Strategy

- **01/02 instances** → Same-account (160885257264 → 160885257264)
- **03/04 instances** → Cross-account (160885257264 → 123456789012)
...
- [External Deployment Strategy](../docs/guides/EXTERNAL_DRS_DEPLOYMENT_STRATEGY.md)
