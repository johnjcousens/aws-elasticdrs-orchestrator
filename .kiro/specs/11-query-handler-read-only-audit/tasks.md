...
- [ ] 8. Monitor Lambda sizes (Validates: Requirements FR5, Success Criteria)
  - [ ] 8.1 Measure query-handler deployment package size using `aws lambda get-function --function-name aws-drs-orchestration-query-handler-dev`
  - [ ] 8.2 Measure data-management-handler deployment package size using `aws lambda get-function --function-name aws-drs-orchestration-data-management-handler-dev`
  - [ ] 8.3 Measure execution-handler deployment package size using `aws lambda get-function --function-name aws-drs-orchestration-execution-handler-dev`
