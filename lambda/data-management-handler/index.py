...
def lambda_handler(event, context):
    ...
    Direct Invocation Event (External Mode):
    {
        "operation": "create_protection_group",
        "body": {...}
    }
    ...
    try:
        ...
        if "requestContext" in event:
            ...
            # Direct invocation (External mode)
...
def handle_direct_invocation(event, context):
    """Handle direct Lambda invocation (External mode)"""
...
def resolve_protection_group_tags(body: Dict) -> Dict:
    ...
    {
        "region": "us-east-1",
        "serverSelectionTags": {"DR-Application": "External", "DR-Tier": "Database"}
    }
