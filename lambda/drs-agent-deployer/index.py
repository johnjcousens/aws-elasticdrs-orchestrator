...
Event Structure:
{
    ...
    "external_id": "drs-orchestration-dev-160885257264",  # Auto-generated if not provided
...
- Example: drs-orchestration-dev-160885257264
- Can be overridden in event payload

Cross-Account Replication Pattern:
- Agents installed in source_account_id (e.g., 160885257264)
- Agents replicate TO staging_account_id (e.g., 664418995426)
