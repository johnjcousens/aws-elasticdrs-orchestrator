...
**Evidence**:
```
Found target account 777788889999 from Protection Group pg-current-account
Using target account 777788889999 with default role name
Result: {
...
def determine_target_account_context(plan: Dict) -> Dict:
    try:
        ...
        current_account_id = os.environ.get('AWS_ACCOUNT_ID', '777788889999')
