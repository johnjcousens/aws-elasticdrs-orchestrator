...
├── check_ssm_status.sh
├── create_instances_664418995426.sh  ⚠️ Contains account ID in filename
...
```bash
ORCHESTRATION_ACCOUNT="438465159935"
TARGET_ACCOUNT="160885257264"
STAGING_ACCOUNT="664418995426"
```
**Risk**: LOW - These are example/development account IDs
...
**3. create_instances_664418995426.sh**
**Risk**: LOW - Filename contains account ID
**Action**: Rename to `create_instances_example.sh`

**4. empty-frontend-buckets.sh** (Line 67-68)
```bash
empty_bucket "aws-drs-orchestration-fe-438465159935-test"
empty_bucket "aws-drs-orchestration-fe-438465159935-dev"
```
...
- `160885257264` - Development/test account (used in examples)
- `664418995426` - Development/test account (used in examples)
- `438465159935` - Development/test account (used in examples)
...
```bash
# Before
create_instances_664418995426.sh
