...
| 3        | **Dual Mode Orchestration**         | 3-4w | Unified tag-based orchestration supporting UI, CLI, SSM, and Step Functions invocation methods. Same data model and execution engine with dynamic server discovery via DRS tags instead of manual server selection.                    | Planned     | [Implementation Plan](docs/implementation/DUAL_MODE_ORCHESTRATION_DESIGN.md)   | -               | -                        |
