...
```mermaid
flowchart TB
    subgraph Hub["Hub Account (777788889999)"]
...
4. Parameters:
   - **SourceAccountNumber**: `777788889999` (hub account)
...
{
  "Principal": {
    "AWS": "arn:aws:iam::777788889999:role/drs-orchestration-orchestration-role-test"
  },
  "Condition": {
    "StringEquals": {
