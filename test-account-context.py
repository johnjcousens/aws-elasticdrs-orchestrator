...
MOCK_PROTECTION_GROUPS = {
    'pg-test-123': {
        'GroupId': 'pg-test-123',
        'GroupName': 'Test-PG',
        'AccountId': '438465159935',  # Target account
        'Region': 'us-west-2'
    }
}
...
MOCK_TARGET_ACCOUNTS = {
    '438465159935': {
        ...
        'CrossAccountRoleArn': 'arn:aws:iam::438465159935:role/DRSOrchestrationCrossAccountRole'
    }
}
...
def test_account_context_scenarios():
    ...
    plan_with_target = {
        ...
        'Waves': [
            {
                'WaveNumber': 1,
                'ProtectionGroupId': 'pg-test-123'  # This PG has AccountId: 438465159935
            }
        ]
    }
