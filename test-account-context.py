...
MOCK_PROTECTION_GROUPS = {
    'pg-test-123': {
        'GroupId': 'pg-test-123',
        'GroupName': 'Test-PG',
        'AccountId': '***REMOVED***',  # Target account
        'Region': 'us-west-2'
    }
}
...
MOCK_TARGET_ACCOUNTS = {
    '***REMOVED***': {
        ...
        'CrossAccountRoleArn': 'arn:aws:iam::***REMOVED***:role/DRSOrchestrationCrossAccountRole'
    }
}
...
def test_account_context_scenarios():
    ...
    plan_with_target = {
        ...
        'Waves': [
            {
                'WaveNumber': 1,
                'ProtectionGroupId': 'pg-test-123'  # This PG has AccountId: ***REMOVED***
            }
        ]
    }
