...
2. **Go to Network tab**
3. **Select an account** from dropdown (e.g., "DEMO_TARGET - 160885257264")
4. **Check API requests**:
   - Look for requests to `/protection-groups?accountId=160885257264`
   - Look for requests to `/recovery-plans?accountId=160885257264`
   - Look for requests to `/executions?accountId=160885257264`
5. **Verify responses** only contain items for selected account
6. **Check Console tab** for logs:
   ```
   [ProtectionGroupsPage] Account changed to: 160885257264
   [ProtectionGroupsPage] Fetching groups for account: 160885257264
   ```
