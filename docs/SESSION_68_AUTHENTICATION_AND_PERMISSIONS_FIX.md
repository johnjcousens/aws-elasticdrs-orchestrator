...
aws cognito-idp admin-initiate-auth --user-pool-id us-east-1_wfyuacMBX --client-id 48fk7bjefk88aejr1rc7dvmbv0 --auth-flow ADMIN_NO_SRP_AUTH --auth-parameters USERNAME=testuser@example.com,PASSWORD="IiG2b1o+D$" --region us-east-1
