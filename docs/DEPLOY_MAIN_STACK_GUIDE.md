...
Example: `aws-drs-orchestration-210987654321-test`
...
- **Deployment Bucket**: `aws-drs-orchestration-210987654321-qa`
...
aws s3 rm s3://aws-drs-orchestration-qa-fe-210987654321 --recursive

# Empty deployment bucket
aws s3 rm s3://aws-drs-orchestration-210987654321-qa --recursive
```
...
3. Manually sync if needed:
   ```bash
   aws s3 sync cfn/ s3://aws-drs-orchestration-210987654321-qa/cfn/
   ```
...
1. Check if bucket exists:
   ```bash
   AWS_PAGER="" aws s3 ls s3://aws-drs-orchestration-210987654321-qa
   ```
