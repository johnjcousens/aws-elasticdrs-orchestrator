...
- `arn:aws:dynamodb:us-east-2:210987654321:table/aws-drs-orchestration-protection-groups-test`
- `arn:aws:dynamodb:us-east-2:210987654321:table/aws-drs-orchestration-recovery-plans-test`
- `arn:aws:dynamodb:us-east-2:210987654321:table/aws-drs-orchestration-execution-history-test`

**Example Denied Resources**:
- `arn:aws:dynamodb:us-east-2:210987654321:table/other-project-table` (doesn't match pattern)
...
- `arn:aws:lambda:us-east-2:210987654321:function:aws-drs-orchestration-execution-handler-test`

**Example Denied Resources**:
- `arn:aws:lambda:us-east-2:210987654321:function:aws-drs-orchestration-data-management-handler-test` (wrong function)
- `arn:aws:lambda:us-east-2:210987654321:function:other-project-function` (wrong project)
...
- `arn:aws:dynamodb:us-east-2:210987654321:table/aws-drs-orchestration-recovery-plans-test`
- `arn:aws:dynamodb:us-east-2:210987654321:table/aws-drs-orchestration-execution-history-test`
- `arn:aws:dynamodb:us-east-2:210987654321:table/aws-drs-orchestration-target-accounts-test`
...
**Example Allowed Resource**:
- `arn:aws:lambda:us-east-2:210987654321:function:aws-drs-orchestration-data-management-handler-test`

**Example Denied Resources**:
- `arn:aws:lambda:us-east-2:210987654321:function:aws-drs-orchestration-query-handler-test` (different function)
- `arn:aws:lambda:us-east-2:210987654321:function:aws-drs-orchestration-execution-handler-test` (different function)
...
**Example Allowed Resources**:
- `arn:aws:events:us-east-2:210987654321:rule/aws-drs-orchestration-tag-sync-schedule-test`

**Example Denied Resources**:
- `arn:aws:events:us-east-2:210987654321:rule/other-project-rule` (doesn't match pattern)
...
**Example Allowed Resources**:
- `arn:aws:states:us-east-2:210987654321:stateMachine:aws-drs-orchestration-dr-orch-sf-test`
- `arn:aws:states:us-east-2:210987654321:execution:aws-drs-orchestration-dr-orch-sf-test:12345678-1234-1234-1234-123456789012`

**Example Denied Resources**:
- `arn:aws:states:us-east-2:210987654321:stateMachine:other-project-state-machine` (doesn't match pattern)
...
**Example Allowed Resources**:
- `arn:aws:sns:us-east-2:210987654321:aws-drs-orchestration-execution-alerts-test`
- `arn:aws:sns:us-east-2:210987654321:aws-drs-orchestration-security-alerts-test`

**Example Denied Resources**:
- `arn:aws:sns:us-east-2:210987654321:other-project-topic` (doesn't match pattern)
...
**Example Allowed Resources**:
- `arn:aws:lambda:us-east-2:210987654321:function:aws-drs-orchestration-execution-handler-test`
- `arn:aws:lambda:us-east-2:210987654321:function:aws-drs-orchestration-query-handler-test`

**Example Denied Resources**:
- `arn:aws:lambda:us-east-2:210987654321:function:aws-drs-orchestration-data-management-handler-test` (different function)
...
**Example Allowed Resources**:
- `arn:aws:s3:::aws-drs-orchestration-210987654321-fe-test` (bucket)
- `arn:aws:s3:::aws-drs-orchestration-210987654321-fe-test/*` (objects)
- `arn:aws:s3:::aws-drs-orchestration-210987654321-fe-qa` (bucket)
- `arn:aws:s3:::aws-drs-orchestration-210987654321-fe-qa/*` (objects)

**Example Denied Resources**:
- `arn:aws:s3:::aws-drs-orchestration-210987654321-test` (deployment bucket, not frontend)
...
s3 = boto3.client('s3')
versions = s3.list_object_versions(Bucket='aws-drs-orchestration-210987654321-fe-test')

for version in versions.get('Versions', []):
    if not version.get('IsLatest'):
        s3.delete_object(
            Bucket='aws-drs-orchestration-210987654321-fe-test',
            Key=version['Key'],
...
**Example Allowed Resources**:
- `arn:aws:cloudformation:us-east-2:210987654321:stack/aws-drs-orchestration-test/*`
- `arn:aws:cloudformation:us-east-2:210987654321:stack/aws-drs-orchestration-qa/*`

**Example Denied Resources**:
- `arn:aws:cloudformation:us-east-2:210987654321:stack/other-project-stack/*` (doesn't match pattern)
...
**Example ARNs**:
- `arn:aws:events:us-east-2:210987654321:rule/aws-drs-orchestration-tag-sync-schedule-test`
- `arn:aws:events:us-east-2:210987654321:rule/aws-drs-orchestration-execution-polling-schedule-test`
...
def lambda_handler(event, context):
    ...
    for server_id in ['s-1234567890abcdef0', 's-0987654321fedcba0']:
        drs.tag_resource(
            resourceArn=f'arn:aws:drs:us-east-2:210987654321:source-server/{server_id}',
            tags={
...
def lambda_handler(event, context):
    ...
    execution = sfn.start_execution(
        stateMachineArn='arn:aws:states:us-east-2:210987654321:stateMachine:aws-drs-orchestration-dr-orch-sf-test',
    ...
    sns.publish(
        TopicArn='arn:aws:sns:us-east-2:210987654321:aws-drs-orchestration-execution-alerts-test',
...
def lambda_handler(event, context):
    ...
    s3 = boto3.client('s3')
    bucket_name = 'aws-drs-orchestration-210987654321-fe-test'
...
**Example Error**:
```
botocore.exceptions.ClientError: An error occurred (AccessDeniedException) when calling the GetItem operation: User: arn:aws:sts::210987654321:assumed-role/aws-drs-orchestration-query-handler-role-test/aws-drs-orchestration-query-handler-test is not authorized to perform: dynamodb:GetItem on resource: arn:aws:dynamodb:us-east-2:210987654321:table/other-project-table because no identity-based policy allows the dynamodb:GetItem action on that resource
```
...
**Example Error**:
```
botocore.exceptions.ClientError: An error occurred (AccessDeniedException) when calling the StartRecovery operation: User: arn:aws:sts::210987654321:assumed-role/aws-drs-orchestration-orchestration-role-test/aws-drs-orchestration-dr-orch-sf-test is not authorized to perform: drs:StartRecovery with an explicit deny in an identity-based policy due to condition key 'aws:RequestedRegion'
```
...
**Example Error**:
```
botocore.exceptions.ClientError: An error occurred (AccessDenied) when calling the AssumeRole operation: User: arn:aws:sts::210987654321:assumed-role/aws-drs-orchestration-orchestration-role-test/aws-drs-orchestration-dr-orch-sf-test is not authorized to perform: sts:AssumeRole on resource: arn:aws:iam::123456789012:role/DRSOrchestrationRole
```
...
AssumeRolePolicyDocument:
  ...
  Statement:
    - Effect: Allow
      Principal:
        AWS: "arn:aws:iam::210987654321:root"  # Orchestration account
      Action: sts:AssumeRole
      Condition:
        StringEquals:
...
**Example Error**:
```
Resource handler returned message: "Invalid request provided: Role ARN arn:aws:iam::210987654321:role/aws-drs-orchestration-query-handler-role-test does not exist" (RequestToken: 12345678-1234-1234-1234-123456789012, HandlerErrorCode: InvalidRequest)
```
...
**Example Error**:
```
botocore.exceptions.ClientError: An error occurred (AccessDeniedException) when calling the Invoke operation: User: arn:aws:sts::210987654321:assumed-role/aws-drs-orchestration-query-handler-role-test/aws-drs-orchestration-query-handler-test is not authorized to perform: lambda:InvokeFunction on resource: arn:aws:lambda:us-east-2:210987654321:function:aws-drs-orchestration-data-management-handler-test because no identity-based policy allows the lambda:InvokeFunction action on that resource
```
...
# Expected: arn:aws:iam::210987654321:role/aws-drs-orchestration-query-handler-role-test
```
...
# Expected: arn:aws:iam::210987654321:role/aws-drs-orchestration-unified-role-test
```
...
|---------|------------|---------|
| DynamoDB | `arn:aws:dynamodb:{Region}:{AccountId}:table/{ProjectName}-*` | `arn:aws:dynamodb:us-east-2:210987654321:table/aws-drs-orchestration-protection-groups-test` |
| Lambda | `arn:aws:lambda:{Region}:{AccountId}:function:{ProjectName}-{function}-{Environment}` | `arn:aws:lambda:us-east-2:210987654321:function:aws-drs-orchestration-query-handler-test` |
| Step Functions | `arn:aws:states:{Region}:{AccountId}:stateMachine:{ProjectName}-*` | `arn:aws:states:us-east-2:210987654321:stateMachine:aws-drs-orchestration-dr-orch-sf-test` |
| SNS | `arn:aws:sns:{Region}:{AccountId}:{ProjectName}-*` | `arn:aws:sns:us-east-2:210987654321:aws-drs-orchestration-execution-alerts-test` |
| EventBridge | `arn:aws:events:{Region}:{AccountId}:rule/{ProjectName}-*` | `arn:aws:events:us-east-2:210987654321:rule/aws-drs-orchestration-tag-sync-schedule-test` |
| S3 (Frontend) | `arn:aws:s3:::{ProjectName}-*-fe-*` | `arn:aws:s3:::aws-drs-orchestration-210987654321-fe-test` |
| CloudFormation | `arn:aws:cloudformation:{Region}:{AccountId}:stack/{ProjectName}-*/*` | `arn:aws:cloudformation:us-east-2:210987654321:stack/aws-drs-orchestration-test/*` |
