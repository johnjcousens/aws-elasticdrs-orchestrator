...
User: arn:aws:sts::210987654321:assumed-role/aws-drs-orchestration-query-handler-role-qa/aws-drs-orchestration-query-handler-qa 
...
3. **Check IAM Policy Simulator**:
   ...
   aws iam simulate-principal-policy \
     --policy-source-arn arn:aws:iam::210987654321:role/aws-drs-orchestration-query-handler-role-qa \
...
arn:aws:dynamodb:us-east-2:210987654321:table/external-table 
...
User: arn:aws:sts::210987654321:assumed-role/aws-drs-orchestration-orchestration-role-qa/aws-drs-orchestration-dr-orch-sf-qa 
...
2. **Check the template URL**:
   ...
   aws s3 ls s3://aws-drs-orchestration-210987654321-qa/cfn/iam/roles-stack.yaml --region us-east-2
   ```
...
2. **Sync the template to S3**:
   ```bash
   aws s3 sync cfn/ s3://aws-drs-orchestration-210987654321-qa/cfn/ --region us-east-2
   ```
3. **Retry the deployment**:
   ```bash
   ./scripts/deploy-main-stack.sh qa --use-function-specific-roles
...
aws iam simulate-principal-policy \
  ...
  --resource-arns "arn:aws:dynamodb:us-east-2:210987654321:table/aws-drs-orchestration-protection-groups-qa"
...
#       "EvalResourceName": "arn:aws:dynamodb:us-east-2:210987654321:table/aws-drs-orchestration-protection-groups-qa",
...
aws iam simulate-principal-policy \
  --policy-source-arn arn:aws:iam::210987654321:role/aws-drs-orchestration-orchestration-role-qa \
...
1. **Check the SNS subscription**:
   ...
   aws sns list-subscriptions-by-topic \
     --topic-arn arn:aws:sns:us-east-2:210987654321:aws-drs-orchestration-security-alerts-qa \
     --region us-east-2
   ```
