...
│  │                                                                │  │
│  │  Trust Policy:                                                 │  │
│  │  - Principal: arn:aws:iam::438465159935:root                  │  │
...
**3. Information Gathering:**
	- Hub AWS Account ID: `438465159935` (example)
...
aws secretsmanager put-resource-policy \
    ...
    --resource-policy '{
        ...
        "Statement": [{
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::438465159935:role/drs-orchestration-lambda-execution-role-test"
            },
...
**Key Elements:**
	- **Principal**: Hub account ID (438465159935 in example)
...
6. Enter Hub Account ID: `438465159935`
