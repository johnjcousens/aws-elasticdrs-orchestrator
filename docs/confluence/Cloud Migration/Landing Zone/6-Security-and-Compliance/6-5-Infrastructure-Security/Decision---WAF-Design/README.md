...
**Confluence Page:** https://healthedge.atlassian.net/wiki/spaces/CP1/pages/4867065270/Decision---WAF-Design
...
Determine if AWS WAF and/or AWS Firewall Manager will be used
...
* To provide for a more comprehensive Layer 7 protection and to offload an operational overhead related to the management of the WAF Rules, [Customer] will use the following 
...
* Customer can also select 
  [AWS Marketplace Rules Groups](https://docs.aws.amazon.com/waf/latest/developerguide/marketplace-managed-rule-groups.html) 
  to subscribe to in addition to AWS Managed Rules Groups in the future.
