# Accessing--AWS-Resources-using-Federated-Access

**Confluence Page:** https://healthedge.atlassian.net/wiki/spaces/CP1/pages/4967039242/Accessing--AWS-Resources-using-Federated-Access
...
This document describes steps to take to access AWS Console, or AWS CLI using federated identities. Granting access through federation or roles is an AWS Well-Architected best practice.
