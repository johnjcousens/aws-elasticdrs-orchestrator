# Implementation--of-ADFS-Federation

**Confluence Page:** https://healthedge.atlassian.net/wiki/spaces/CP1/pages/4967039040/Implementation--of-ADFS-Federation

**Created by:** Lei Shi on July 29, 2025  
**Last modified by:** Lei Shi on July 29, 2025 at 05:07 PM

---

This solution should only be considered after ruling out using AWS IAM Identity Center for console and CLI federation.
...
| --- | --- |
| **Name** | **Value** |
| ADFS Login URL | [https://sts.example.com/adfs/ls/IdpInitiatedSignOn.aspx?loginToRp=urn:amazon:webservices](https://sts.example.com/adfs/ls/IdpInitiatedSignOn.aspx?loginToRp=urn:amazon:webservices+) |
| ADFS Prod Login URL |  |
| AWS Account IDs Matrix | Complete the AWS Account matrix located on the following page: <https://myitportal.atlassian.net/wiki/pages/resumedraft.action?draftId=2431419424> |
| User to Role Matrix | Complete the User to Role matrix located on the following page: Decision---Human-IAM-Roles-and-Policies-Design |
...
![worddav81822fd08883c1c5b2725b40ca4f0056.png](images/worddav81822fd08883c1c5b2725b40ca4f0056.png)

Choose **Add Relying Party Trust** to start the **Add Relying Party Trust Wizard**.  
![worddavc4727d69a0f2883a01aea7cc3ef42ecc.png](images/worddavc4727d69a0f2883a01aea7cc3ef42ecc.png)

Choose **Start** to begin. Then, on **Select Data Source**, type the following URL for the AWS SAML metadata, and then choose **Next**. <https://signin.aws.amazon.com/static/saml-metadata.xml>  
![worddav263d72c33bdad28c34cff8093481efb1.png](images/worddav263d72c33bdad28c34cff8093481efb1.png)
...
![worddavd3d94017e489772c4b43dd983f79abaf.png](images/worddavd3d94017e489772c4b43dd983f79abaf.png)
...
![worddav1a654cab0051793d6bbf7bae24e823c0.png](images/worddav1a654cab0051793d6bbf7bae24e823c0.png)

Choose **Add Rule...** to configure the first rule, and then choose **Transform an incoming claim**. Finally, choose **Next**.  
![worddav7fcd133233cf40d27caefc20340d3314.png](images/worddav7fcd133233cf40d27caefc20340d3314.png)
...
![worddavc586eb24cde90445c056a48551ab6d15.png](images/worddavc586eb24cde90445c056a48551ab6d15.png)

Choose **Add Rule** to configure the second rule, and then choose **Send LDAP Attributes as Claims**. Finally, choose **Next**.  
![worddavdd8e0de9e7c983bfe4e094583d28b3a0.png](images/worddavdd8e0de9e7c983bfe4e094583d28b3a0.png)
...
![worddavc720642e92490d89c12cc4bd4fb27a7e.png](images/worddavc720642e92490d89c12cc4bd4fb27a7e.png)

Choose **Add Rule** to configure the third rule, and then choose **Send claims using a custom rule**. Finally, choose **Next**.  
![worddav98bd3d7a798398f3dbea16bffe0b2901.png](images/worddav98bd3d7a798398f3dbea16bffe0b2901.png)

n the **Claim rule name** box, type **Get AD Groups**. In the **Custom rule** box, enter the following, and then choose **OK**.

##### **Get AD Groups Claim Rule**

add(store = "Active Directory", types = ("http://temp/variable"), query = ";tokenGroups;{0}", param = c.Value);]]>

This custom rule uses a script in the claim rule language that retrieves all the groups the authenticated user is a member of and places them into a temporary claim named [{+}](http://temp/variable)<http://temp/variable+>. Think of this as a variable you can access later.  
**Note**: Ensure that there isn't any trailing whitespace, as this may cause unexpected results.  
![worddavb48e179844952cb622c3e8b272ae9540.png](images/worddavb48e179844952cb622c3e8b272ae9540.png)
...
![worddav471c568b0e313c9d60fdc4b1f54c31e2.png](images/worddav471c568b0e313c9d60fdc4b1f54c31e2.png)

Choose **OK** to complete the **Edit Claim Rules** wizard.  
![worddavf7740c8573bba0486e1e23e49db126d8.png](images/worddavf7740c8573bba0486e1e23e49db126d8.png)
...
### Login to the Management AWS account using an IAM account with Admin permissions
...
![image2017-11-12_10-13-24.png](images/image2017-11-12_10-13-24.png)

1. Under IAM users sign-in link: select **Customize**

![image2017-11-12_10-23-37.png](images/image2017-11-12_10-23-37.png)

1. Type in the name of the Alias (e.g. acme-management, acme-sharedservices, acme-security, acme-dev, etc.)

![image2017-11-12_10-27-0.png](images/image2017-11-12_10-27-0.png)
...
1. Download IdP metadata
   ...
   1. [https://sts.example.com/FederationMetadata/2007-06/FederationMetadata.xml](https://sts.acme.com/FederationMetadata/2007-06/FederationMetadata.xml)
2. Go to IAM Service Dashboard
3. Select **Idetity providers** from the left pane and then choose **Create Provider**.

![image2017-11-12_10-35-51.png](images/image2017-11-12_10-35-51.png)

1. Enter the following values to configure the provider, and choose **Next Step**.
   ...
   ![image2017-11-12_10-41-38.png](images/image2017-11-12_10-41-38.png)
2. Verify the information is correct and then choose **Create** to create the identity provider.

![image2017-11-12_10-42-17.png](images/image2017-11-12_10-42-17.png)

1. The banner at the top of the screen provides confirmation that your identity provider was successfully created.

![image2017-11-12_10-54-19.png](images/image2017-11-12_10-54-19.png)
...
![image2017-11-12_10-15-22.png](images/image2017-11-12_10-15-22.png)

1. Select **SAML 2.0 federation** under **Select type of trusted entity**.

![image2017-11-12_10-18-7.png](images/image2017-11-12_10-18-7.png)

1. Set the **SAML provider** to **ADFS** using the drop-down list menu. This configuration defines the specific federation provider that provides authentication and authorization into the role.
2. Review the role trust policy (no changes required) and choose **Next Step** to continue.
3. Select "Allow programmatic and AWS Management Console Access

![image2017-11-12_10-59-58.png](images/image2017-11-12_10-59-58.png)

1. Choose **Next: Permissions**
2. Select the ***ReadOnlyAccess*** policy.
...
![image2017-11-12_10-6-50.png](images/image2017-11-12_10-6-50.png)

1. Set the Role Name to **ADFS-ReadOnly**.

![image2017-11-12_11-7-48.png](images/image2017-11-12_11-7-48.png)

1. Finally, repeat the entire sequence of the preceding steps for the following two additional roles.
...
1. Login to the Management AWS account using Federated Login

   1. [https://sts.example.com/adfs/ls/IdpInitiatedSignOn.aspx?loginToRp=urn:amazon:webservices](https://sts.acme.com/adfs/ls/IdpInitiatedSignOn.aspx?loginToRp=urn:amazon:webservices+)
...
##### **Replace STS FQDN with the customers and save as a .ps1**
...
##### **Use different credentials save as .ps1**
...
##### **Use different credentials and code role selection save as .ps1**
...
##### **Python 3.x Federated Login Script**
...
##### **Python 2.x Federated Login Script**
...
