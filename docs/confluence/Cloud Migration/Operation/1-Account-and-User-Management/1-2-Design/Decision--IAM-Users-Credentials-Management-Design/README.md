...
**Confluence Page:** https://healthedge.atlassian.net/wiki/spaces/CP1/pages/4967792669/Decision--IAM-Users-Credentials-Management-Design

**Created by:** Lei Shi on July 29, 2025  
**Last modified by:** Lei Shi on July 29, 2025 at 05:05 PM
...
| --- | --- | --- | --- |
| <Namespace>-user- breakglass | Emergency access in case SAML is down | Ability to assume breakglass IAM Role in all accounts | <Namespace>-user-breakglass Access Policy {  "Version": "October 17, 2012",  "Statement": \[  {  "Effect": "Allow",  "Action": "sts:AssumeRole",  "Resource": "arn:aws:iam::\\*:role/<Namespace>-role-breakglass"  }  \]  } |
...
2. [Customer] will also use a set of manual procedures to detect unused privileges which can be automated in the future.