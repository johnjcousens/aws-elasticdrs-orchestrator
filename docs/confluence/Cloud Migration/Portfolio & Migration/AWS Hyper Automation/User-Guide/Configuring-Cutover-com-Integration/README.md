# Configuring-Cutover-com-Integration

**Confluence Page:** https://healthedge.atlassian.net/wiki/spaces/CP1/pages/4867097041/Configuring-Cutover-com-Integration
...
**Note:** requires the Hyper Automation solution to be deployed

Cutover.com will act as a UI for runbook management, triggering automations in the Hyper Automation Solution. In order to connect Cutover.com to Hyper Automation, the customer will need to decide one of three paths (refer to the

for more information) when deploying the solution (refer tofor more information):
...
![1-settings-integrations.png](images/1-settings-integrations.png)

**2.** Create a new Custom Integration. Provide a name and click Create
![2-create-integration.png](images/2-create-integration.png)
![3-new-integration.png](images/3-new-integration.png)
...
![4-navigate-to-integration.png](images/4-navigate-to-integration.png)
![5-edit-integration.png](images/5-edit-integration.png)

**4.** Select 'Build a Custom Integration' as action. Then click Create.
![6-new-action.png](images/6-new-action.png)

**5.** Configure the General settings for the integrated action as follows:
![7-configure-integration-1.png](images/7-configure-integration-1.png)
...
![8-configure-integration-2.png](images/8-configure-integration-2.png)
...
![9-configure-integration-3.png](images/9-configure-integration-3.png)
...
![10-integration-configured.png](images/10-integration-configured.png)
...
![11-check-integration.png](images/11-check-integration.png)

### Option 2: Requesting Cutover Connect

Cutover Connect can act as a one-way bridge between the runbook management system and the automation engine. In order to enable Cutover Connect, the customer will have to make a request to the Cutover team to set up their instance with Connect. It is worth noting that Cutover Connect will incur a fee to enable in the customer’s instance. This fee can be discussed between Cutover and customer.
