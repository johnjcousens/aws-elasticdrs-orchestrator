...
```mermaid
flowchart TB
    subgraph "Hub Account (123456789012)"
        QH[query-handler]
    ...
    QH -->|5. Write Audit Log<br/>source_account: 123456789012<br/>target_account: 123456789012<br/>assumed_role_arn<br/>cross_account_session| AUDIT_TABLE
