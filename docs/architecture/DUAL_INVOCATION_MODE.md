...
**Context ARN**:
```
arn:aws:sts::123456789012:assumed-role/ExecutionRole/session-name
```
...
**Context ARN**:
```
arn:aws:events::123456789012:rule/inventory-sync
```
...
def test_direct_lambda_invocation_with_iam_role():
    ...
    context = MockLambdaContext(
        invoked_function_arn="arn:aws:sts::123456789012:assumed-role/ExecutionRole/session"
    )
