...
**Examples**:
- Target account (dev): `drs-orchestration-dev-160885257264`
- Staging account (dev): `drs-orchestration-dev-664418995426`
- Target account (prod): `drs-orchestration-prod-160885257264`
...
- **Target Account**: 160885257264 (recovery destination)
...
```bash
# Deploy to target account (160885257264)
...
# Expected: drs-orchestration-dev-160885257264
...
# Expected: drs-orchestration-dev-664418995426
```
...
- Old: `arn:aws:iam::160885257264:role/DRSOrchestrationRole`
- New: `arn:aws:iam::160885257264:role/DRSOrchestrationRole-dev`
