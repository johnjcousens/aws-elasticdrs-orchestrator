...
aws stepfunctions describe-state-machine \
  --state-machine-arn arn:aws:states:us-east-2:123456789012:stateMachine:dr-orchestration-qa \
...
aws events put-targets \
  --rule aws-drs-orchestration-inventory-sync-qa \
  --targets Id=1,Arn=arn:aws:lambda:us-east-2:123456789012:function:query-handler  # Old target
```
...
aws stepfunctions get-execution-history \
  --execution-arn arn:aws:states:us-east-2:123456789012:execution:dr-orchestration-qa:exec-123
