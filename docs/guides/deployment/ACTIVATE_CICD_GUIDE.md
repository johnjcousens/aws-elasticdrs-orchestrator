...
## Prerequisites
- AWS CLI configured with profile `777788889999_AdministratorAccess`
...
# Should show Account: 777788889999
```
...
aws sns subscribe \
  --topic-arn arn:aws:sns:us-east-1:777788889999:aws-elasticdrs-orchestrator-pipeline-notifications \
  --protocol email \
