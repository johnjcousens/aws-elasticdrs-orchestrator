...
|-------------|-------|-------------|
| `AWS_ROLE_ARN` | `arn:aws:iam::438465159935:role/aws-elasticdrs-orchestrator-github-actions-dev` | IAM role ARN from Step 1 |
...
flowchart TB
    ...
    subgraph AWS["AWS Account: 438465159935"]
        subgraph IAM
            OIDC[OIDC Provider]
