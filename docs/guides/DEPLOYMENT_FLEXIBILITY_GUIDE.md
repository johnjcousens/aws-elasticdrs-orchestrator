...
**Solution:**
Verify External Platform role includes all 16 policies from UnifiedOrchestrationRole. See [External Platform Role Requirements](#external-role-requirements).
