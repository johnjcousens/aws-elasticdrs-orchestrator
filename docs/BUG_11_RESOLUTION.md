...
User: arn:aws:sts::438465159935:assumed-role/.../DRSOrchestrationApiHandler is not authorized 
to perform: drs:GetLaunchConfiguration on resource: arn:aws:drs:us-east-1:438465159935:source-server/*
```
