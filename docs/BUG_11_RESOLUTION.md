...
User: arn:aws:sts::***REMOVED***:assumed-role/.../DRSOrchestrationApiHandler is not authorized 
to perform: drs:GetLaunchConfiguration on resource: arn:aws:drs:us-east-1:***REMOVED***:source-server/*
```
