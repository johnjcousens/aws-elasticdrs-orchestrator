...
### Step 4: Deploy to S3
```bash
aws s3 sync frontend/dist/ s3://drs-orchestration-fe-777788889999-test/ --delete
```
...
# Verify deployment
aws s3 ls s3://drs-orchestration-fe-777788889999-test/ | grep index
...
cd frontend
npx vite build --mode production
aws s3 sync dist/ s3://drs-orchestration-fe-777788889999-test/ --delete
