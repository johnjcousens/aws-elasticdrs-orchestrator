...
│  │                                                                │  │
│  │  Trust Policy:                                                 │  │
│  │  - Principal: arn:aws:iam::***REMOVED***:root                  │  │
...
**3. Information Gathering:**
	- Hub AWS Account ID: `***REMOVED***` (example)
...
aws secretsmanager put-resource-policy \
    ...
    --resource-policy '{
        ...
        "Statement": [{
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::***REMOVED***:role/drs-orchestration-lambda-execution-role-test"
            },
...
**Key Elements:**
	- **Principal**: Hub account ID (***REMOVED*** in example)
...
6. Enter Hub Account ID: `***REMOVED***`
