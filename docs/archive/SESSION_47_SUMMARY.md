...
- Uploaded to S3: `s3://drs-orchestration-fe-***REMOVED***-test/aws-config.js`
...
aws s3 cp /tmp/aws-config.js \
  s3://drs-orchestration-fe-***REMOVED***-test/aws-config.js \
...
aws s3 ls s3://drs-orchestration-fe-***REMOVED***-test/aws-config.js
