...
2. **Verify Deployment Bucket Structure**
   ...
   aws s3 ls s3://aws-drs-orchestration-210987654321-test/cfn/ --recursive
...
4. **Test Environment Access**
   - Verify AWS credentials for test account (210987654321)
...
aws s3 sync cfn/ s3://aws-drs-orchestration-210987654321-test/cfn/ \
  --exclude "*.md" \
  --exclude ".DS_Store" \
  --region us-east-2
...
2. **Verify Data Integrity**
   ...
   AWS_PAGER="" aws stepfunctions list-executions \
     --state-machine-arn arn:aws:states:us-east-2:210987654321:stateMachine:aws-drs-orchestration-dr-orch-sf-test \
