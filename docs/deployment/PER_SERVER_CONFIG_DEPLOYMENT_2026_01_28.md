...
### Test Environment
- **Stack ARN**: `arn:aws:cloudformation:us-east-1:777788889999:stack/aws-drs-orchestration-dev/e1e00cb0-fe49-11f0-a956-0ef4995d315b`
- **Created**: January 31, 2026
- **Deployment Bucket**: `s3://aws-drs-orchestration-dev/`
- **Frontend Bucket**: `s3://aws-drs-orchestration-fe-123456789012-dev/`
...
2. ✅ Synced to S3: `aws s3 sync dist/ s3://aws-drs-orchestration-fe-123456789012-dev/ --delete`
...
1. **Frontend Rollback**:
   ...
   aws s3 sync dist/ s3://aws-drs-orchestration-fe-123456789012-dev/ --delete
...
2. **Backend Rollback** (if needed):
   ...
   aws cloudformation cancel-update-stack --stack-name aws-drs-orchestration-dev
   ```
