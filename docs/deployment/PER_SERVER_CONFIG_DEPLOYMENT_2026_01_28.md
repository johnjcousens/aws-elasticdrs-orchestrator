...
### Test Environment
- **Stack ARN**: `arn:aws:cloudformation:us-east-1:438465159935:stack/aws-drs-orchestration-test/e4c0f210-fbc3-11f0-b7ee-0affff4e1ab5`
- **Frontend Bucket**: `s3://aws-drs-orchestration-fe-438465159935-test/`
...
2. ✅ Synced to S3: `aws s3 sync dist/ s3://aws-drs-orchestration-fe-438465159935-test/ --delete`
...
1. **Frontend Rollback**:
   ...
   aws s3 sync dist/ s3://aws-drs-orchestration-fe-438465159935-test/ --delete
