...
CLOUDFRONT_URL=https://***REMOVED***.cloudfront.net
...
```json
{
  ...
  "apiEndpoint": "https://***REMOVED***.execute-api.us-east-1.amazonaws.com/dev"
}
```
...
|--------|-------|-------------|
| `AWS_ROLE_ARN` | `arn:aws:iam::***REMOVED***:role/GitHubActionsRole` | OIDC role for AWS access |
...
# Check frontend
curl -I https://***REMOVED***.cloudfront.net
```
