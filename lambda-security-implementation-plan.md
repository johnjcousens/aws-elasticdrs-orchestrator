...
curl -H "Authorization: Bearer $TOKEN" "https://akp69tt2m1.execute-api.us-east-1.amazonaws.com/dev/health"
...
curl -X POST -H "Authorization: Bearer $TOKEN" \
  ...
  "https://akp69tt2m1.execute-api.us-east-1.amazonaws.com/dev/recovery-plans/test-plan/execute"
...
curl -H "Authorization: Bearer $TOKEN" \
  "https://akp69tt2m1.execute-api.us-east-1.amazonaws.com/dev/executions" | jq '.executions | length'
