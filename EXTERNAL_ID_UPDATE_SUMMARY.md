...
- ✅ Updated Pattern 1 example: `drs-orchestration-dev-160885257264`
- ✅ Updated Pattern 2 example: `drs-orchestration-dev-664418995426`
...
- ✅ Updated External ID to `drs-orchestration-dev-160885257264`
...
|-------------|---------|------------|-------------|
| dev | Target | 160885257264 | `drs-orchestration-dev-160885257264` |
| dev | Staging | 664418995426 | `drs-orchestration-dev-664418995426` |
| test | Target | 160885257264 | `drs-orchestration-test-160885257264` |
| test | Staging | 664418995426 | `drs-orchestration-test-664418995426` |
| prod | Target | 160885257264 | `drs-orchestration-prod-160885257264` |
| prod | Staging | 664418995426 | `drs-orchestration-prod-664418995426` |
...
- [ ] Deploy cross-account roles to target account (160885257264)
- [ ] Deploy cross-account roles to staging account (664418995426)
...
2. **What's the new pattern?** - `{ProjectName}-{Environment}-{AccountId}` (e.g., `drs-orchestration-dev-160885257264`)
