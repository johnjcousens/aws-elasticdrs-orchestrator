...
describe('Staging Accounts Integration Tests', () => {
  ...
  describe('Add Staging Account End-to-End Flow', () => {
    it('should complete full add staging account workflow', async () => {
      ...
      await user.type(accountIdInput, '664418995426');
      await user.type(accountNameInput, 'STAGING_01');
      await user.type(roleArnInput, 'arn:aws:iam::664418995426:role/DRSOrchestrationRole-test');
      await user.type(externalIdInput, 'drs-orchestration-test-664418995426');
    ...
    it('should handle validation failure gracefully', async () => {
      ...
      await user.type(
        ...
        'arn:aws:iam::664418995426:role/InvalidRole'
      );
  ...
  describe('Remove Staging Account End-to-End Flow', () => {
    it('should complete full remove staging account workflow', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText(/664418995426/)).toBeTruthy();
      });
  ...
  describe('Capacity Query with Multiple Staging Accounts', () => {
    it('should display combined capacity across all accounts', async () => {
       ...
       */
      const targetAccountId = '160885257264';
