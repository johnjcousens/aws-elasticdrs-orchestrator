...
**Stack ARN**: `arn:aws:cloudformation:us-east-1:777788889999:stack/aws-elasticdrs-orchestrator-test/e7ca8600-ef35-11f0-a7ff-0affc82f71e1`  
...
- **CloudFront URL**: `https://d13m3tjpjn4ots.cloudfront.net`
- **Distribution ID**: `E38EWIMJP3JB4Z`
- **S3 Bucket**: `aws-elasticdrs-orchestrator-fe-777788889999-test`

### Authentication Configuration
- **User Pool ID**: `us-east-1_9sxQSfYYQ`
- **User Pool Client ID**: `635au0e3dk35iktj60h2huic3a`
- **Identity Pool ID**: `us-east-1:6b586035-4fa1-4b4d-96f6-695900dbf2fc`
- **Test User**: `testuser@example.com` / `TestPassword123!`
- **User Group**: `DRSOrchestrationAdmin`

### Step Functions Configuration
- **State Machine ARN**: `arn:aws:states:us-east-1:777788889999:stateMachine:aws-elasticdrs-orchestrator-orchestration-test`
