...
# Creates ***REMOVED*** with ***REMOVED*** and adds to Admin RBAC group
...
OPTIONS:
    ...
    --test-email EMAIL          Test user email (default: ***REMOVED***)
    --test-password PASSWORD    Test user password (default: ***REMOVED***)
