...
class PEP8ComplianceChecker:
    ...
    def check_black_formatting(self) -> Dict:
        ...
        try:
            ...
            return {"tool": "black", "compliant": False, "error": str(e)}
    ...
    def check_isort_imports(self) -> Dict:
        ...
        try:
            ...
            return {"tool": "isort", "compliant": False, "error": str(e)}
    ...
    def check_flake8_violations(self) -> Dict:
        ...
        try:
                                ...
                                violations.append(
                                    {
                                        ...
                                        "code": code,
                                        "message": message,
                                        "severity": self._get_violation_severity(
                                            code
                                        ),
                                    }
                                )

                                violation_counts[code] = (
                                    violation_counts.get(code, 0) + 1
                                )
            ...
            return {"tool": "flake8", "compliant": False, "error": str(e)}
    ...
    def fix_formatting_issues(self) -> Dict:
        ...
        try:
            ...
            results["black_fix"] = {"success": False, "error": str(e)}
        ...
        try:
            ...
            results["isort_fix"] = {"success": False, "error": str(e)}
    ...
    def generate_compliance_report(self) -> Dict:
        ...
        compliance_percentage = (
            (tools_compliant / total_tools * 100) if total_tools > 0 else 0
        )
    ...
    def _generate_recommendations(self) -> List[str]:
        ...
        if not recommendations:
            recommendations.append(
                "✅ Code is PEP 8 compliant! Maintain quality with pre-commit hooks"
            )
        else:
            recommendations.append(
    ...
    def print_summary(self, report: Dict) -> None:
        ...
        for tool_name, result in report["tool_results"].items():
            ...
            print(
                f"  {status_icon} {tool_name.title()}: {'PASS' if compliant else 'FAIL'}"
            )
        ...
        if violation_analysis["total_violations"] > 0:
            print(f"\nViolation Breakdown:")
            print(
                f"  Total Violations: {violation_analysis['total_violations']}"
            )
...
def main():
    ...
    parser.add_argument(
        "--output", help="Output filename for report (default: auto-generated)"
    )
        ...
        if args.fix:
            ...
            for tool, result in fix_results.items():
                if result.get("success"):
                    ...
                    print(
                        f"❌ {tool} fixes failed: {result.get('error', 'Unknown error')}"
                    )
