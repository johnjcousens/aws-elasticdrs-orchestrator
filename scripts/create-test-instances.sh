        ...
        cat > "$lt_file" << EOF
{
    ...
    "TagSpecifications": [
        {"ResourceType": "instance", "Tags": [
            ...
            {"Key": "BusinessUnit", "Value": "External"},
            ...
            {"Key": "Application", "Value": "Example-Core-Platform"},
...
if [[ "$DRY_RUN" == true ]]; then
    ...
    echo "    --filters 'Name=tag:Application,Values=Example-Core-Platform' 'Name=instance-state-name,Values=running' \\"
