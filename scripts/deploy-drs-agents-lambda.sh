...
#
# Examples:
#   ./deploy-drs-agents-lambda.sh 160885257264
#   ./deploy-drs-agents-lambda.sh 160885257264 us-east-1 us-west-2
#   ./deploy-drs-agents-lambda.sh 664418995426 us-east-1 eu-west-1
...
if [ -z "$ACCOUNT_ID" ]; then
  ...
  echo "Examples:"
  echo "  $0 160885257264"
  echo "  $0 160885257264 us-east-1 us-west-2"
  echo "  $0 664418995426 us-east-1 eu-west-1"
  echo ""
