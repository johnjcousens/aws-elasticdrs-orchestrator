...
class UserRoleManager:
    ...
    def create_user(self, email: str, temporary_password: str, 
                   ...
                   department: str = '', job_title: str = '') -> bool:
        """Create a new user"""
        try:
            user_attributes = [
...
def main():
    ...
    # List users command
    list_parser = subparsers.add_parser('list-users', help='List all users and their roles')
    ...
    add_parser.add_argument('--role', required=True, choices=list(DRS_ROLES.keys()), help='Role name')
    ...
    remove_parser.add_argument('--role', required=True, choices=list(DRS_ROLES.keys()), help='Role name')
    ...
    create_parser.add_argument('--temp-password', required=True, help='Temporary password')
    ...
    create_parser.add_argument('--role', choices=list(DRS_ROLES.keys()), help='Initial role to assign')
    
    # Set password command
    password_parser = subparsers.add_parser('set-password', help='Set permanent password')
    password_parser.add_argument('--username', required=True, help='Username (email)')
    password_parser.add_argument('--password', required=True, help='New permanent password')
    ...
    if args.command == 'list-users':
        ...
        success = manager.create_user(
            args.email, args.temp_password,
            args.given_name or '', args.family_name or '',
            args.department or '', args.job_title or ''
        )
