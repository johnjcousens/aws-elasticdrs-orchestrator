...
def check_temporal_references(file_path: str, content: str) -> List[CodeQualityIssue]:
    ...
    for line_num, line in enumerate(lines, 1):
        ...
        if '#' in line or '//' in line:
            comment_part = line.split('#')[-1] if '#' in line else line.split('//')[-1]
...
def check_redundant_comments(file_path: str, content: str) -> List[CodeQualityIssue]:
