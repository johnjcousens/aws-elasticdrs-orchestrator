...
echo "Creating 6 new instances (05/06 series) in account 664418995426..."
echo "VPC: $VPC_ID"
...
echo "2. Deploy DRS agents: ./scripts/deploy_drs_agents.sh 664418995426 us-east-1 us-west-2"
echo ""
