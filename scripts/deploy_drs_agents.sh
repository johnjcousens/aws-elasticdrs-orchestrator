...
#
# Parameters:
#   account_id     - AWS account ID (default: 160885257264)
...
#   ./deploy_drs_agents.sh 160885257264                       # Specify account
#   ./deploy_drs_agents.sh 160885257264 us-east-1 us-west-2  # Full specification
#   ./deploy_drs_agents.sh 438465159935 us-east-1 us-west-2  # Different account
#
...
# Example: ./deploy_drs_agents.sh 160885257264 us-east-1 us-west-2

# Parse parameters
ACCOUNT_ID="${1:-160885257264}"
