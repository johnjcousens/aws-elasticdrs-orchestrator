...
def main():
    parser = argparse.ArgumentParser(description='Add current AWS account as a target account')
    parser.add_argument('--account-name', help='Friendly name for the account')
    parser.add_argument('--table-name', help='DynamoDB table name (auto-detected if not provided)')
