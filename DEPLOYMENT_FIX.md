...
## Error Details
```
User: arn:aws:sts::438465159935:assumed-role/aws-elasticdrs-orchestrator-dev-Lamb-ApiHandlerRole-mgni4Le6HWh7/aws-elasticdrs-orchestrator-api-handler-dev is not authorized to perform: drs:UpdateLaunchConfiguration
```
