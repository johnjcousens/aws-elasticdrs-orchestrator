...
ARCHIVE_AWS_ROLE_ARN="arn:aws:iam::438465159935:role/GitHubActionsRole"  # Same as current
...
```bash
ARCHIVE_AWS_ROLE_ARN="arn:aws:iam::438465159935:role/GitHubActionsRole"
```
