...
- `ARCHIVE_ADMIN_EMAIL` - Admin email for archive test stack: `***REMOVED***`
...
ARCHIVE_AWS_ROLE_ARN="arn:aws:iam::***REMOVED***:role/GitHubActionsRole"  # Same as current
...
ARCHIVE_ADMIN_EMAIL="***REMOVED***"                                # As specified
```
...
```bash
ARCHIVE_AWS_ROLE_ARN="arn:aws:iam::***REMOVED***:role/GitHubActionsRole"
```
